import { IDestination, IDestinationContent, IDestinationMonthContent, IDestionationFaq, IDestionationMonthFaq, IHolidayBlog, IWeatherData, IWeatherMonthData } from '@/(types)/type';
